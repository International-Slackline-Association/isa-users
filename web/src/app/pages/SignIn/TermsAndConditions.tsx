  ...
  return (
    <div>
      ...
      <p>
        ...
        to it, still belong to International Slackline Association.
      </p>
      <p>
        International Slackline Association is committed to ensuring that the app is as useful and
        efficient as possible. For that reason, we reserve the right to make changes to the app or
        to charge for its services, at any time and for any reason. We will never charge you for the
        app or its services without making it very clear to you exactly what you're paying for.
      </p>
      <p>
        The ISA Account app stores and processes personal data that you have provided to us, to
        ...
        programs, compromise your phone's security features and it could mean that the ISA Account
      ...
      <p>
        With respect to International Slackline Association's responsibility for your use of the
        app, when you're using the app, it's important to bear in mind that although we endeavor to
        ensure that it is updated and correct at all times, we do rely on third parties to provide
        information to us so that we can make it available to you. International Slackline
        Association accepts no liability for any loss, direct or indirect, you experience as a
        result of relying wholly on this functionality of the app.
      </p>
      <p>
        At some point, we may wish to update the app. The app is currently available as a web
        application. International Slackline Association does not promise that it will always update
      ...
      <p>
        ...
        contact us at account@slacklineinternational.org.
      </p>
    </div>
  );
};
